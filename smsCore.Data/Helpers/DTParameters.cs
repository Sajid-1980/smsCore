...
namespace smsCore.Data.Helpers.DataTables
{
    /// <summary>
    ...
    public class DataTablesIn
    {
        ...
        ///     drawn in sequence by DataTables
        ///     (Ajax requests are asynchronous and thus can return out of sequence). This is used as part of the draw return
        ///     parameter (see below).DONT MESS WITH THIS IF YOU WANT DATATABLES TO WORK PROPERLY
        /// </summary>
        public int draw { get; set; }

        /// <summary>
        ///     Paging first record indicator. This is the start point in the current data set (0 index based - i.e. 0 is the first
        ///     record).
        /// </summary>
        ...
        ///     returned will be equal to this number,
        ...
        /// <summary>
        ///     The MVC Model binder is simply not good enough to parse the structure passed to us by datatables. We make up for it
        ///     by passing a JSON string
    ...
    public class DTColumn
    {
        ...
        /// <summary>
        ///     Flag to indicate if this column is searchable (true) or not (false). This is controlled by the columns.searchable
        ///     Option within Datatables.
        /// </summary>
        public bool searchable { get; set; }

        /// <summary>
        ///     Flag to indicate if this column is orderable (true) or not (false). This is controlled by the columns.searchable
        ///     Option within Datatables.
        /// </summary>
